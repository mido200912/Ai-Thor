  ...
  const integrations = [
    {
      ...
      action: () => window.location.href = `http://localhost:5000/api/integrations/meta/login?companyId=${company._id}`
    },
    {
      id: 'instagram',
      name: 'Instagram',
    ...
    },
    {
      ...
      action: () => {
        ...
        if (shop) {
          window.location.href = `http://localhost:5000/api/integrations/shopify/login?shop=${shop}&companyId=${company._id}`;
        }
      }
    }
  ];
        ...
        <div className="card">
          ...
          <div className="code-block" style={{ background: '#1a1a1a', padding: '15px', borderRadius: '8px', position: 'relative' }}>
            <code style={{ color: '#00ff88', fontFamily: 'monospace', wordBreak: 'break-all' }}>
              &lt;script src="http://localhost:5000/api/integrations/widget/script.js?companyId={company._id}"&gt;&lt;/script&gt;
            </code>
            <button
              ...
              onClick={() => navigator.clipboard.writeText(`<script src="http://localhost:5000/api/integrations/widget/script.js?companyId=${company._id}"></script>`)}
            >
              Copy
            </button>
          </div>
