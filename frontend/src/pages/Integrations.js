                    ...
                    <div className="glass-card" style={{ padding: '25px' }}>
                        ...
                        <div className="code-block" style={{ background: '#1a1a1a', padding: '15px', borderRadius: '8px', position: 'relative' }}>
                            <code style={{ color: '#00ff88', fontFamily: 'monospace', wordBreak: 'break-all' }}>
                                &lt;script src="http://localhost:5000/api/integrations/widget/script.js?companyId=YOUR_COMPANY_ID"&gt;&lt;/script&gt;
                            </code>
                            <button
                                ...
                                onClick={() => navigator.clipboard.writeText('<script src="http://localhost:5000/api/integrations/widget/script.js?companyId=YOUR_COMPANY_ID"></script>')}
                            >
                                Copy
                            </button>
                        </div>
